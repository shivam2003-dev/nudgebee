...
// ErrorAction is the response shape Hasura actions expect for errors.
...
// ErrorActionBadRequest returns a Hasura-action-shaped error for 4xx responses.
...
// ErrorActionInternal returns a Hasura action error shape intended for
