...
func (s *VersionsRESTHandlerTestSuite) TestListVersionsSuccess() {
	...
	expected := []model.WorkflowVersion{
		...
		{ID: "v-2", WorkflowID: "wf-1", VersionNumber: 2, Source: model.WorkflowVersionSourceSave},
	}
...
func (s *VersionsRESTHandlerTestSuite) TestGetVersionSuccess() {
	t := s.T()
	expected := &model.WorkflowVersion{ID: "v-2", WorkflowID: "wf-1", VersionNumber: 2, Source: model.WorkflowVersionSourceSave}
