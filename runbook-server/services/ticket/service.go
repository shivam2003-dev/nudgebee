...
// Internal structs to match RPC/Ticket-Server expectations
type ActionTicketRequest struct {
	Action           ActionAction           `json:"action"`
...
func GetTicket(ctx *security.RequestContext, request GetTicketRequest) (GetTicketResponse, error) {
	...
	headers := map[string]string{}
	resp, err := common.HttpPost(config.Config.TicketServerEndpoint+"/tickets/rpc/get-ticket", common.HttpWithHeaders(headers), common.HttpWithJsonBody(actionReq))
	if err != nil {
...
func GetTicketComments(ctx *security.RequestContext, request GetTicketCommentsRequest) (GetTicketCommentsResponse, error) {
	...
	headers := map[string]string{}
	resp, err := common.HttpPost(config.Config.TicketServerEndpoint+"/tickets/rpc/get-comments", common.HttpWithHeaders(headers), common.HttpWithJsonBody(actionReq))
	if err != nil {
...
func AcknowledgeTicket(ctx *security.RequestContext, request AcknowledgeTicketRequest) (AcknowledgeTicketResponse, error) {
	...
	headers := map[string]string{}
	resp, err := common.HttpPost(config.Config.TicketServerEndpoint+"/tickets/rpc/acknowledge", common.HttpWithHeaders(headers), common.HttpWithJsonBody(actionReq))
	if err != nil {
...
func EscalateTicket(ctx *security.RequestContext, request EscalateTicketRequest) (EscalateTicketResponse, error) {
	...
	// Build rpc request with escalation policy in additional fields
	...
	headers := map[string]string{}
	resp, err := common.HttpPost(config.Config.TicketServerEndpoint+"/tickets/rpc/escalate", common.HttpWithHeaders(headers), common.HttpWithJsonBody(actionReq))
	if err != nil {
...
func UpdateTicket(ctx *security.RequestContext, request UpdateTicketRequest) (UpdateTicketResponse, error) {
	...
	// Build rpc request with update fields in additional_fields
	actionReq := map[string]any{
		"action": map[string]string{
			"name": "update",
		},
	...
	headers := map[string]string{}
	resp, err := common.HttpPost(config.Config.TicketServerEndpoint+"/tickets/rpc/update", common.HttpWithHeaders(headers), common.HttpWithJsonBody(actionReq))
	if err != nil {
...
func TransitionTicket(ctx *security.RequestContext, request TransitionTicketRequest) (TransitionTicketResponse, error) {
	...
	// Build rpc request with status in additional_fields
	actionReq := map[string]any{
		"action": map[string]string{
			"name": "transition",
		},
	...
	headers := map[string]string{}
	resp, err := common.HttpPost(config.Config.TicketServerEndpoint+"/tickets/rpc/transition", common.HttpWithHeaders(headers), common.HttpWithJsonBody(actionReq))
	if err != nil {
...
func AssignTicket(ctx *security.RequestContext, request AssignTicketRequest) (AssignTicketResponse, error) {
	...
	// Build rpc request with assignee in additional_fields
	actionReq := map[string]any{
		"action": map[string]string{
			"name": "assign",
		},
	...
	headers := map[string]string{}
	resp, err := common.HttpPost(config.Config.TicketServerEndpoint+"/tickets/rpc/assign", common.HttpWithHeaders(headers), common.HttpWithJsonBody(actionReq))
	if err != nil {
...
func ResolveTicket(ctx *security.RequestContext, request ResolveTicketRequest) (ResolveTicketResponse, error) {
	...
	headers := map[string]string{}
	resp, err := common.HttpPost(config.Config.TicketServerEndpoint+"/tickets/rpc/resolve", common.HttpWithHeaders(headers), common.HttpWithJsonBody(actionReq))
	if err != nil {
...
func AddTicketComment(ctx *security.RequestContext, request AddTicketCommentRequest) (AddTicketCommentResponse, error) {
	...
	headers := map[string]string{}
	resp, err := common.HttpPost(config.Config.TicketServerEndpoint+"/tickets/rpc/add-comment", common.HttpWithHeaders(headers), common.HttpWithJsonBody(actionReq))
	if err != nil {
