...
15 interconnected services (9 Go, 5 Python, 1 TypeScript) deployed on Kubernetes via EKS.
...
**Last updated:** April 2026. Verified: 9 Go + 5 Python + 1 TypeScript = 15 total modules.
