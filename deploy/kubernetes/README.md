...
```
helm install hasura -f hasura/values.yaml ./hasura --timeout 3600s  --namespace nudgebee --kube-context 'arn:aws:eks:us-east-1:123456789012:cluster/nudgebee-dev'
...
```
helm install hasura-actions -f hasura-actions/values.yaml ./hasura-actions --timeout 3600s  --namespace nudgebee --kube-context 'arn:aws:eks:us-east-1:123456789012:cluster/nudgebee-dev'
