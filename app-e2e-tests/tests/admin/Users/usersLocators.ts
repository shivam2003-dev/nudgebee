...
export class UserLocators extends CommonLocators {
  ...
  constructor(page: Page) {
    ...
    this.successMsg = page.getByText("User Added Successfully");
    this.duplicateMsg = page.getByText("This email is already in use");
  ...
  getRoleOption(role: string): Locator {
    return this.page.locator('[role="option"]').filter({ has: this.page.getByText(role, { exact: true }) });
  }
