...
test("Add Confluence Account Integration", async ({ page }) => {
  ...
  // verify Confluence integration section
  ...
  // Fill the Confluence integration form
  ...
  await waitForGraphQLAndValidate(
    ...
    },
    {
      ...
      ignoreErrorMessages: ["account 'iteration-test' already has a 'confluence' integration ('Conflue-Test'); only one 'confluence' integration per account is supported — edit the existing one or remove it before adding another"],
    },
  );
});
