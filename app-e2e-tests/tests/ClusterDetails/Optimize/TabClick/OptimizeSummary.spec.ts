...
test("Graphql testing Cluster Details->Optimize-> Summary", async ({ page }, testInfo) => {
  ...
  await expect(locators.OptimizedropdownSummary).toBeVisible();
  await waitForGraphQLAndValidate(
    page,
    async () => {
      await locators.OptimizedropdownSummary.click();
    },
    {
