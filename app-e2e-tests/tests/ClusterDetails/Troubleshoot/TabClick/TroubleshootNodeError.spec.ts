...
test("Graphql testing Cluster Details->Troubleshoot-> Node Errors", async ({ page }, testInfo) => {
  ...
  await expect(locators.TroubleshootNodeErrors).toBeVisible();
  await waitForGraphQLAndValidate(
    page,
    async () => {
      await locators.TroubleshootNodeErrors.click();
    },
    {
