...
func handleAccountAction(actionPayload *ActionRequest, c *gin.Context, tracer *trace.Tracer, meter *metric.Meter, logger *slog.Logger) {
	accountRequest := actionPayload.Input
	...
	case "cloud_accounts_delete":
		...
		return
	case "cloud_accounts_insert_one", "accounts_create":
	...
	case "agent_token_create", "agents_create_token":
		...
		c.JSON(200, resp)
		return
	case "aws_org_onboard", "accounts_create_aws_org":
	...
	case "aws_onboard_status", "accounts_check_aws_onboarding":
	...
	case "azure_eventgrid_onboard", "azure_get_onboard_eventgrid_url":
	...
	case "aws_eventbridge_onboard", "aws_get_onboard_eventbridge_url":
	...
	case "validate_cloud_credentials", "cloud_check_credentials":
	...
	case "azure_bulk_onboard", "accounts_create_azure_subscriptions_bulk":
	...
	case "gcp_bulk_onboard", "accounts_create_gcp_projects_bulk":
	...
	case "messaging_platform_list", "messagingplatforms_list":
	...
	case "messaging_platform_update", "messagingplatforms_update":
	...
	case "messaging_platform_delete", "messagingplatforms_delete":
