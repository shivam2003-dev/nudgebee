...
// HasuraActionError mirrors common.ErrorHasuraActionBadRequest output —
// {"message": "...", "extensions": {"code": "..."}} — the standard Hasura
// action error envelope.
type HasuraActionError struct {
...
// @Failure      400 {object} HasuraActionError
