...
func handleHasuraSloAction(hasuraPayload *HasuraActionRequest, c *gin.Context, tracer *trace.Tracer, meter *metric.Meter, logger *slog.Logger) {
	sloRequest := hasuraPayload.Input
