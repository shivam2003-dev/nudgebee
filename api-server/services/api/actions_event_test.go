...
func TestRefreshEvent(t *testing.T) {
	...
	if eventId == "" {
		eventId = "b6b7f656-5841-45bb-bc81-71a9ee996101" // Azure VM alert - Test Disk Space Alert v2
	}
	if tenant == "" {
		t.Skip("TEST_TENANT not set")
	}
...
func TestProcessEventTriage(t *testing.T) {
	tenant := os.Getenv("TEST_TENANT")
	eventId := "cdc6fb6a-dbec-48c1-808f-16f25e16e7d5" // Event from events_202512082226.json
...
func TestBackfillTriage(t *testing.T) {
	...
	fingerprint := "2705eb5b6e1d199f4a710ec7aa974167cc5b2a901ca6834806e90fe961ac913a"
...
func TestReplayWebhookEvent(t *testing.T) {
	...
	err := core.ReplayWebhookEvent(ctxt, "91323d40-73c0-43d3-b74a-09df6eb17e1b")
	if err == nil {
