...
Exposed via Hasura actions in [actions_knowledge_graph.go](../api/actions_knowledge_graph.go): `kg_get_complete_graph`, `kg_get_node`, `kg_get_edge`, `kg_get_filter_options`, `kg_get_node_neighbors`, `kg_traverse`, `kg_search_nodes`, `build_knowledge_graph`.
