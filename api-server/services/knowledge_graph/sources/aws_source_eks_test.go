...
func TestExtractClusterMetadata_RoleArn(t *testing.T) {
	...
	meta := map[string]interface{}{
		"RoleArn": "arn:aws:iam::740395098545:role/nudgebee-eks-role",
		"Status":  "ACTIVE",
		"Version": "1.33",
	}
	...
	if got := props["role_arn"]; got != "arn:aws:iam::740395098545:role/nudgebee-eks-role" {
...
func TestCreateEKSEdges_FullTopology(t *testing.T) {
	...
	eks := &core.DbNode{
		...
		Properties: map[string]interface{}{
			...
			"name":        "nudgebee",
			"role_arn":    "arn:aws:iam::740395098545:role/nudgebee-eks-role",
		},
	}
	...
	role := &core.DbNode{NodeType: core.NodeTypeServiceIdentity, Properties: map[string]interface{}{"arn": "arn:aws:iam::740395098545:role/nudgebee-eks-role"}}
