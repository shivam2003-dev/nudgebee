...
func TestK8sListObjects2(t *testing.T) {
	...
	resp, err := k8sListResourceNames(NewSecurityContextForSuperAdmin(), "0053b816-4b45-4dcd-a612-19545110f8aa", K8sRbacSubjectTypeUser, "nb-eks-test-2", "pods", K8sRbacPermissionTypeGet)
	assert.Nil(t, err)
	assert.NotNil(t, resp)
