...
func TestSignozAction(t *testing.T) {
	...
	defaultPlaybookActionContext := playbooks.NewPlaybookActionContext(os.Getenv("TEST_TENANT"), "e9dc2b39-78d3-46da-9691-f160bd3c4c19", slog.Default(), playbooks.PlaybookEvent{
...
func TestBuildSignozLogsExplorerURL(t *testing.T) {
	baseURL := "https://telemetry.fourkites.com"
