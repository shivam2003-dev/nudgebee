...
func TestTimeline(t *testing.T) {
	...
	ctxt := security.NewRequestContextForTenantAdmin(m[testenv.Tenant], nil, nil, nil)
	...
	timeline, err := BuildEventTimeline(ctxt.GetContext(), dbms.Db, m["TEST_EVENT_ID"], tenantID)
