...
func TestAnomoly(t *testing.T) {
	err := refreshAgentPlaybooks(context.Background(), slog.Default(), "e9dc2b39-78d3-46da-9691-f160bd3c4c19")
...
func TestExecutePlaybookForPagerDuty(t *testing.T) {
	...
	response, err := ExecutePlaybook(security.NewRequestContextForSuperAdmin(slog.Default(), nil, nil), "e9dc2b39-78d3-46da-9691-f160bd3c4c19", playbooks.PlaybookEvent{
...
func TestExecutePlaybookProxyDBQuery(t *testing.T) {
	response, err := ExecutePlaybook(
		...
		"26c58daf-e449-453e-b374-a0d79f74819a",
		playbooks.PlaybookEvent{
