...
// This is used for manual triggering via the trigger_anomaly_execute RPC action.
...
func ListAnomalyTemplate(context *security.RequestContext, request AnomalyListTemplateRequest) ([]AnomalyTemplate, error) {
	return readJSONFile()
}
