    ...
    "paths": {
            ...
            "post": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Bad Request",
                        "schema": {
                            "$ref": "#/definitions/api.HasuraActionError"
                        }
                    }
                }
            }
        ...
        "/hasura-cron": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Hasura scheduled-event payload (` + "`" + `{id, name, payload, scheduled_time}` + "`" + `)",
                        "name": "payload",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/v1/export/recommendations": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Hasura action envelope wrapping ExportRecommendationsRequest in ` + "`" + `input.request` + "`" + `",
                        "name": "payload",
                        "in": "body",
                        "required": true,
                        "schema": {
