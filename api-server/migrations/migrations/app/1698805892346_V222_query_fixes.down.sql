...
alter table "public"."dw_queries" alter column "query_id" set not null;
...
alter table "public"."dw_queries" alter column "bill_interval_to" set not null;

alter table "public"."dw_queries" alter column "bill_interval_from" set not null;
