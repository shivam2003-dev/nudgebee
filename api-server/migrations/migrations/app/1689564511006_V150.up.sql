...
CREATE
OR REPLACE VIEW "public"."recommendation_groupings_type" AS
SELECT r.tenant_id AS tenant_id,
	...
	r.rule_name AS recommendation_rule_name,
...
CREATE
OR REPLACE FUNCTION public.recommendation_groupings(
  group_by text [] DEFAULT '{}' :: text [],
  "where" json DEFAULT NULL :: json,
  hasura_session json DEFAULT '{}' :: json
) RETURNS SETOF recommendation_groupings_type LANGUAGE SQL STABLE AS $FUNCTION$
SELECT
