...
func TestE2EPRList(t *testing.T) {
	...
	req := AgenticAnalyzeRequest{
		...
		GitRepository: GitRepository{
			URL:    "/Users/mayankpande/Documents/work/nudgebee/nudgebee",
			Branch: "main",
		},
...
func TestLogAnalysis(t *testing.T) {
	...
	req := AgenticAnalyzeRequest{
		...
		AgentID: "code_agent",
		GitRepository: GitRepository{
			URL:    "https://mayankpande88@github.com/nudgebee/nudgebee.git",
			Branch: "main",
		},
		GitCredentials: credentials.GitCredentials{
			Type:  "token",
...
func TestListCollectorServerPRs(t *testing.T) {
	...
	if req.GitRepository.URL == "" {
		req.GitRepository.URL = "/Users/mayankpande/Documents/work/nudgebee/nudgebee"
	}
