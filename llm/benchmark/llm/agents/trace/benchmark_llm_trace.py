"""Trace agent benchmark — unified nubi format.

Agent: traces
Tool: traces_execute (fetched from DB)
...
AGENT = "traces"
TOOL_NAMES = ["traces_execute"]
DB_TOOL_NAME = "traces_execute"
FIXTURES_DIR = Path(__file__).parent / "fixtures"


@pytest.mark.benchmark
def test_trace_benchmark():
    """Run trace agent benchmark with unified nubi format."""
