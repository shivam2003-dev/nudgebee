...
from holmes.plugins.toolsets.newrelic.new_relic_api import NewRelicAPI  # noqa: E402
    ...
    for attempt in range(1, max_attempts + 1):
        ...
        try:
            ...
            nrql_query = (
                ...
                "WHERE request.uri='/orders' "
                "AND appName LIKE '%checkout%' "
                "AND namespaceName = 'app-117' "
