"""GCP Traces agent benchmark — unified nubi format.
...
AGENT = "gcp"
TOOL_NAMES = ["gcloud_execute"]
FIXTURES_DIR = Path(__file__).parent / "fixtures"


@pytest.mark.benchmark
def test_gcp_traces_benchmark():
    """Run GCP traces agent benchmark with unified nubi format."""
