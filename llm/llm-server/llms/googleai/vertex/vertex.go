...
func (g *Vertex) GenerateContent(
	...
	harmThreshold := convertHarmThreshold(g.opts.HarmThreshold)
		...
		if candidate.Content != nil {
			for _, part := range candidate.Content.Parts {
				...
				case genai.FunctionCall:
					b, err := common.MarshalJson(v.Args)
					if err != nil {
						return nil, err
					}
...
// convertHarmThreshold maps the new string-based googleai.HarmBlockThreshold to the
// legacy int32-based vertexai HarmBlockThreshold used by cloud.google.com/go/vertexai/genai.
func convertHarmThreshold(ht googleai.HarmBlockThreshold) genai.HarmBlockThreshold {
	switch ht {
