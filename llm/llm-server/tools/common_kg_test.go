...
func TestFormatKGSearchResponse(t *testing.T) {
	...
	t.Run("renders table with ids", func(t *testing.T) {
		data := map[string]any{
			"nodes": []any{
				map[string]any{
					"id":               "abc123def456",
	...
	t.Run("character cap is enforced", func(t *testing.T) {
		...
		out := formatKGSearchResponse(map[string]any{"nodes": nodes, "total_count": 500})
