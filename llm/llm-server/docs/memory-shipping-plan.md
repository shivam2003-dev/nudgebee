...
- `/v1/memory_v2` Hasura action (Soul/Prefs get/set/clear)
...
### Migrations
`V707, V708, V709, V710, V711, V712, V717` — all additive, Hasura-applied on deploy.
...
2. Hasura applies V707–V712, V717 on dev.
