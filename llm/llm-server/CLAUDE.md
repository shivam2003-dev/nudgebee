...
Hasura manages migrations. Files live in `api-server/migrations/migrations/app/`. The LLM server never runs migrations — it reads/writes to the schema Hasura manages.
