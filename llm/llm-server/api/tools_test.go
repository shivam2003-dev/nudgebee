...
func TestTools_List(t *testing.T) {
	...
	tools := core.ListTools(sc, os.Getenv("TEST_PROMETHEUSCHAIN_ACCOUNT"))
...
func TestTools_UpdateTool(t *testing.T) {
	...
	updateDto := core.ToolDto{
		Id:           "0c7289e1-0d9d-4567-9fea-db7963b9711e",
		Name:         toolName,
	...
	err := core.UpdateCustomTool(sc, accountId, toolName, updateDto)
	assert.Nil(t, err)
}
