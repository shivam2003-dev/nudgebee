...
{
  "errors": ["{\"time\":\"2026-03-10T02:10:09.135937654Z\",\"level\":\"ERROR\",\"msg\":\"Failed to process rule, continuing with next rule\",\"cron_job\":\"Insight refresh\",\"cron_id\":\"5f966dcb-5a73-45e5-a8a3-2d2c2e146709\",\"trace_id\":\"00000000000000000000000000000000\",\"ruleId\":\"17\",\"error\":{\"message\":\"invalid aggregate column: invalid SQL identifier: \\\"max(workload_namespace_count)\\\"\",\"type\":\"*fmt.wrapError\",\"stacktrace\":\"nudgebee/services/insight.Process(0xc02da91620, {0x0, 0x0, 0x0})\\n\\t/app/insight/service.go:198 +0x7cd\\nnudgebee/services/api.handleHasuraCrons.func1.2()\\n\\t/app/api/hasura_cron.go:106 +0x8a\\ncreated by nudgebee/services/api.handleHasuraCrons.func1 in goroutine 1064\\n\\t/app/api/hasura_cron.go:102 +0x42b\\n\"}}"],
