...
func (o *NBReActPlanner3) llmCompressScratchpad(scratchpad string, maxChars int, steps []NBAgentPlannerToolActionStep) string {
	...
	timeoutCtx, cancel := context.WithTimeout(
		context.WithValue(context.WithoutCancel(o.ctx.GetContext()), ContextKeyUseLiteModel, true),
...
func (o *NBReActPlanner3) runCritique(input, scratchpad, finalAnswer string, intermediateSteps []NBAgentPlannerToolActionStep, logger interface {
	...
	critiqueResult, critiqueErr := GenerateAndTrackLLMContent(o.ctx, o.request.UserId, o.request.AccountId, o.request.ConversationId, o.request.MessageId, o.request.AgentId, false, critiqueMessages, true, llms.WithTemperature(0.0))
	...
	if decision == "" {
		...
		for retryCount := 0; retryCount < o.retryConfig.MaxRetries; retryCount++ {
			...
			retryCritique, retryErr := GenerateAndTrackLLMContent(o.ctx, o.request.UserId, o.request.AccountId, o.request.ConversationId, o.request.MessageId, o.request.AgentId, false, retryMessages, true, llms.WithTemperature(0.0))
			if retryErr != nil {
				continue
			}
