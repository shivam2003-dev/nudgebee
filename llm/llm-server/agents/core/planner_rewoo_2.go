...
func (o *ReWooPlanner2) initializeGraph(ctx context.Context, input string, intermediateSteps []NBAgentPlannerToolActionStep) error {
	...
	if o.request.EnableCritique || o.isInvestigationRequest {
		availableTools := FilterAndInjectDefaultTools(o.request.AccountId, o.nbAgent, o.systemMessage, o.nbAgent.GetSupportedTools(o.ctx), o.request.Capabilities)
...
`
	...
	// Filter and inject tools
	tools = FilterAndInjectDefaultTools(request.AccountId, nbAgent, agentPrompt, tools, request.Capabilities)
