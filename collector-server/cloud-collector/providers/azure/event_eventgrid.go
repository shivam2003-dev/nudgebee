...
func StartAzureServiceBusConsumer(pCtx providers.CloudProviderContext, eventHandler providers.ProcessedEventHandler) {
	...
	// Instantiate the azureProvider to pass to the TemplatedEventGridProcessor
	azureProviderInstance := &azureProvider{}
	processor := NewTemplatedEventGridProcessor(rules, azureProviderInstance)
