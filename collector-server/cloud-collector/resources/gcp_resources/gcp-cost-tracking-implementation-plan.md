...
Create `/path/to/workspace/nudgebee/collector-server/cloud-collector/providers/gcloud/gcloud_usage_report.go` with:
...
Modify the `GetUsageReport` method in `/path/to/workspace/nudgebee/collector-server/cloud-collector/providers/gcloud/main.go` (lines 80-83):
...
Create `/path/to/workspace/nudgebee/collector-server/cloud-collector/providers/gcloud/gcloud_usage_report_test.go` with:
