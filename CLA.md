...
Software Foundation Individual Contributor License Agreement v2.2
(<https://www.apache.org/licenses/icla.pdf>), and is intended to
clarify the intellectual-property license granted with Contributions
from any person or entity to Nudgebee. This license is for your
protection as a Contributor as well as the protection of Nudgebee and
...
A single signature covers both individual and corporate contributors —
if You are signing on behalf of an employer or other legal entity, see
section 8.

## 1. Definitions

"**You**" (or "**Your**") shall mean the copyright owner or legal
entity authorized by the copyright owner that is entering into this
Agreement with Nudgebee. For legal entities, the entity making a
...
intentionally submitted by You to Nudgebee for inclusion in, or
documentation of, any of the products owned or managed by Nudgebee
(the "**Work**"). For the purposes of this definition, "submitted"
means any form of electronic, verbal, or written communication sent
to Nudgebee or its representatives, including but not limited to
communication on electronic mailing lists, source-code-control
systems, and issue-tracking systems that are managed by, or on behalf
of, Nudgebee for the purpose of discussing and improving the Work,
...
grant to Nudgebee and to recipients of software distributed by
Nudgebee a perpetual, worldwide, non-exclusive, no-charge,
royalty-free, irrevocable copyright license to reproduce, prepare
derivative works of, publicly display, publicly perform, sublicense,
and distribute Your Contributions and such derivative works, under
any license, including any subsequent version of the license under
which the Work is then distributed.
...
Nudgebee, or that Your employer has executed a separate Corporate
Contributor License Agreement with Nudgebee.
...
may submit it to Nudgebee separately from any Contribution,
...
You agree to notify Nudgebee of any facts or circumstances of which
You become aware that would make these representations inaccurate in
any respect.

## 8. Signing on Behalf of an Employer

If You are submitting Contributions on behalf of an employer or other
legal entity, You represent that You are authorized to bind that
entity to this Agreement, and Your acceptance of this Agreement will
be deemed to be acceptance by that entity. In that case, references
to "You" in this Agreement refer both to You individually and to the
entity on whose behalf You are signing, and You shall list any
additional authorized contributors from that entity in the signature
record.
...
Individual Contributor License Agreement v2.2][apache-icla], which
underpins the contributor agreements used by many open-source
projects.
