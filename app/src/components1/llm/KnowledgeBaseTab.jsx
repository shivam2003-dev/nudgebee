      ...
      ? [
          {
            ...
            value: 'retrigger',
            icon: RefreshIcon,
            disabled: knowledgeBase.status === 'processing',
          },
        ]
      : []),
    {
            ...
            <Table size='small'>
              <TableHead>
                <TableRow>
                  ...
                  <TableCell sx={{ fontSize: '11px', fontWeight: 600, color: colors.text.tertiary }}>Tokens</TableCell>
                  <TableCell sx={{ fontSize: '11px', fontWeight: 600, color: colors.text.tertiary }}>Provider</TableCell>
                ...
                {history.map((entry) => {
                  ...
                  return (
                    <TableRow key={entry.id}>
                      ...
                      <TableCell sx={{ fontSize: '12px' }}>{entry.document_count}</TableCell>
                      <TableCell sx={{ fontSize: '12px' }}>{entry.total_tokens?.toLocaleString()}</TableCell>
                      <TableCell sx={{ fontSize: '12px' }}>{entry.embedding_model || '-'}</TableCell>
                ...
                <Box sx={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px', mt: 1 }}>
                  {visibleKBs.map((kb) => (
                    <KnowledgeBaseCard
                      ...
                      hasAccess={activeTab === 'manual' ? hasAccess : false}
                    />
                  ))}
                </Box>
              )}
