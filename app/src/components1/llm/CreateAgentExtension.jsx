    ...
    <Box sx={{ display: 'flex', height: '80vh', overflow: 'hidden', position: 'relative' }}>
      ...
      <Box
        sx={{
          ...
          marginBottom: `${ds.space[5]} !important`,
      ...
      >
        <Box display='flex' flexDirection='column' width='100%' mb={ds.space[5]} gap={ds.space[5]}>
          ...
          <Box ref={step1Ref}>
            <FormCard title='Agent Information' description='Overview of the agent being extended' number={1} columns={1} sx={getActiveStepSx(1)}>
              <Box sx={{ p: ds.space[4], backgroundColor: 'var(--ds-blue-100)', borderRadius: 'var(--ds-radius-lg)' }}>
                <Typography
                  sx={{
                ...
                <Typography sx={{ fontSize: 'var(--ds-text-small)', color: 'var(--ds-gray-700)', mb: ds.space[4] }}>
                  {editMode
