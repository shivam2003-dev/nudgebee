import { Popover, Box, Typography, List, ListItem, IconButton, CircularProgress } from '@mui/material';
              ...
              {ref.type === 'file' ? (
                ...
                >
                  ...
                  <IconButton
                    ...
                    sx={{ ml: 1, padding: '4px' }}
                  >
                    {downloadingUrl === ref.url ? <CircularProgress size={16} /> : <FileDownloadIcon fontSize='small' />}
                  </IconButton>
                </Box>
              ) : (
                <a
