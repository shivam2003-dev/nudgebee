    ...
    >
      <Box
        ...
        sx={{
          ...
          '&:hover': { backgroundColor: colors.background.tertiaryLightest, borderColor: colors.border.primary },
          '&:focus-visible': { outline: `2px solid ${colors.border.primary}`, outlineOffset: '2px' },
        }}
      >
        <FaArrowDown size={12} />
      </Box>
