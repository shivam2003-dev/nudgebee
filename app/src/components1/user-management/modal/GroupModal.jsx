      ...
      actionButtons={
        ...
        >
          <CustomButton
            ...
            variant='secondary'
            size='Medium'
            onClick={() => adjustCloseAction(false)}
            sx={{
              textTransform: 'none',
              border: 'none',
              boxShadow: 'none',
              ...
              <Box sx={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                <Box sx={{ display: 'flex', alignItems: 'flex-end', gap: '8px' }}>
                  ...
                  <CustomButton
                    ...
                    size='Medium'
                    onClick={() => {
                      const isDup = showSelectedAccounts.some((a) => a[0].drilldownQuery.id === selectedAccount && a[1].text === selectedAccountRole);
                      if (isDup) {
                        handleSnackBarData({
                    ...
                    sx={{ textTransform: 'none', height: '38px', flexShrink: 0 }}
                  />
                </Box>
