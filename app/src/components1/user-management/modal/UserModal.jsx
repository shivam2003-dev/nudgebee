  ...
  return (
        ...
        >
          <CustomButton
            ...
            sx={{
              ...
              '&:hover': { background: colors.background.suggestionCardHover, border: 'none' },
            }}
          />
          <CustomButton
            ...
            type='submit'
            size='Medium'
            text={isAddMode ? 'Add user' : 'Save changes'}
    ...
    >
      ...
      >
        ...
        {/* Email */}
        <Box>
          {fieldLabel('Work email', isAddMode)}
          <TextField
            sx={inputCustomSx}
            size='small'
            value={emailValue || ''}
        ...
        <Box data-testid='user-modal-group'>
          ...
          <FilterDropdownButton
            ...
            sx={{ width: '100%', display: 'flex', minWidth: 0, height: '38px', borderRadius: '8px', padding: '0 12px' }}
          />
          {isAddMode && (
            <Box sx={{ font: "400 11.5px/1.4 'Roboto'", color: colors.text.tertiaryLight, mt: '5px' }}>
              Groups control which clusters and dashboards this user can access.
            </Box>
          )}
        </Box>
      </Box>
