...
const CFInstancesView = (props: {
  ...
  const onMenuClick = (_menuItem: { id: number }, _data: any) => {};
  ...
  }, [props?.accountId, props?.serviceName, selectedInstanceIdName, selectedTagKey, selectedTagValue, selectedState, rowsPerPage, page]);
  ...
  return (
    <BoxLayout2
      ...
      sharingOptions={{
        download: {
          enabled: true,
          onClick: () => ({ tableId: cfInstancesTable }),
        },
