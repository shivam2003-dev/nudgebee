    ...
    <>
      ...
      >
        {detailedResource.arn && (
          <Box>
            <Box sx={{ color: ds.gray[500], fontSize: ds.text.small, fontWeight: ds.weight.regular, mb: '1px' }}>ARN</Box>
        ...
        {detailedResource.resourse_created_on && (
          <Box>
            <Box sx={{ color: ds.gray[500], fontSize: ds.text.small, fontWeight: ds.weight.semibold, mb: '1px' }}>Created On</Box>
        ...
        {detailedResource.first_seen && (
          <Box>
            <Box sx={{ color: ds.gray[500], fontSize: ds.text.small, fontWeight: ds.weight.semibold, mb: '1px' }}>First Seen</Box>
            <Box sx={{ width: 'fit-content' }}>
        ...
        {detailedResource.last_seen && (
          <Box>
            <Box sx={{ color: ds.gray[500], fontSize: ds.text.small, fontWeight: ds.weight.semibold, mb: '1px' }}>Last Seen</Box>
            <Box sx={{ width: 'fit-content' }}>
              ...
              .map(([key, value]: [string, any]) => {
                ...
                return (
                  <Box key={key} sx={{ minWidth: 0, overflow: 'hidden' }}>
                    <Box sx={{ color: ds.gray[500], fontSize: ds.text.small, fontWeight: ds.weight.regular, mb: '1px' }}>{formattedKey}</Box>
                    <Box sx={{ fontSize: ds.text.body }}>
