...
const ListingRecommendationResolution = ({ accountId, heading }) => {
            ...
            if (containsLink(rr.type_reference_id)) {
              referenceObj['component'] = (
                <Link
                  ...
                  target='_blank'
                  style={{ fontSize: 'var(--ds-text-body)', fontWeight: 400 }}
                >
                  {rr.type}
                </Link>
              );
                ...
                component: (
                  <Box display='flex' flexDirection='column'>
                    {rr.recommendation.rule_name && (
                      <Box sx={{ display: 'flex' }}>
                        <Typography sx={{ fontSize: ds.text.caption, fontWeight: ds.weight.medium, color: ds.gray[700], mr: '4px' }}>
                          Rec:{' '}
                        </Typography>
                    ...
                    {name && (
                      <Box sx={{ display: 'flex' }}>
                        <Typography sx={{ fontSize: ds.text.body, fontWeight: ds.weight.medium, color: ds.gray[700], mr: '4px' }}>Name:</Typography>
                        <Text
                          value={name}
  ...
  return (
    <ListingLayout id={recommendationResolutionTableId}>
      <ListingLayout.Toolbar
        title={heading || 'Recommendation Resolution'}
