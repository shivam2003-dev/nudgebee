...
const CostBlock = ({ title, data, borderColor, backgroundColor }) => {
  ...
  return (
    ...
    >
      ...
      <Currency
        value={data.cost}
        sx={{ color: colors.text.secondary, fontSize: 'var(--ds-text-display)', lineHeight: '32.81px', fontWeight: 'var(--ds-font-weight-semibold)' }}
        suffix={'/mo'}
        withTooltip={false}
        sxPrefix={{ color: colors.text.secondary, marginRight: 'var(--ds-space-1)' }}
          ...
          (item) =>
            data[item.key] !== undefined && (
              <TextWithBorder
                ...
                borderStyle={'solid'}
                sx={{
                  '& p': { fontSize: 'var(--ds-text-small) !important', fontWeight: 'var(--ds-font-weight-regular)', color: colors.text.secondary },
                }}
                spanSx={{
                      ...
                      <Box>
                        ...
                        >
                          <TextWithBorder
                            ...
                            borderStyle={'solid'}
                            sx={{ '& p': { fontSize: 'var(--ds-text-title) !important', color: colors.text.secondary } }}
                          />
                        </Box>
                        <Typography
                          color={colors.text.secondaryDark}
                          ...
                          >
                            <Box width={85}>
                              <Currency
                                ...
                                suffix={'/mo'}
                                withTooltip={false}
                                sxSuffix={{ color: colors.text.secondaryDark, marginLeft: 'var(--ds-space-1)' }}
                              />
                            </Box>
                            <TextWithBorder
                              borderWidth={'1px'}
              ...
              <Box sx={{ gridColumn: 'span 3' }}>
                ...
                >
                  <TextWithBorder
                    ...
                    borderColor={colors.border.primary}
                    borderWidth='3px'
                    sx={{ '& p': { fontSize: 'var(--ds-text-heading)', fontWeight: 'var(--ds-font-weight-semibold)', color: colors.text.secondary } }}
                  />
                  <Box
                    display={'flex'}
                  ...
                  >
                    <Box>
                      <Box mt='24px'>
                        <Typography
                          sx={{ color: colors.text.secondaryDark, fontSize: 'var(--ds-text-small)', fontWeight: 'var(--ds-font-weight-regular)' }}
                        >
                          Auto Optimize Configured
                        </Typography>
                        {loading ? (
                          <Loader />
                        ) : (
                          <Typography
                            sx={{ color: colors.text.secondary, fontSize: 'var(--ds-text-display)', fontWeight: 'var(--ds-font-weight-semibold)' }}
                          >
                            {formatNumber(category.autoPilot?.count, '-', 0, 0)}
                          </Typography>
                        )}
                      </Box>
                      <Divider sx={{ my: 'var(--ds-space-4)', color: colors.text.divider }} />
                      <Box mt='24px'>
                        <Typography
                          sx={{ color: colors.text.secondaryDark, fontSize: 'var(--ds-text-small)', fontWeight: 'var(--ds-font-weight-regular)' }}
                        >
                        ...
                        {loading ? (
                          ...
                          <Typography
                            sx={{ color: colors.text.secondary, fontSize: 'var(--ds-text-display)', fontWeight: 'var(--ds-font-weight-regular)' }}
                          >
