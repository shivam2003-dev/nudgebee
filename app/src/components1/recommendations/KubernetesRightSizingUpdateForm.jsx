...
const KubernetesRightSizingPopupForm = ({
  ...
  const additionalMemInfo = {
    ...
    nbalgoReq: parsedOldRequest || '',
    nbalgoLimit: parsedOldLimit || '',
  };

  const additionalCpuInfo = {
    p99: data?.cpu?.oldRequest,
    p97: data?.cpu?.oldRequest,
    p95: data?.cpu?.oldRequest,
    nbalgo: data?.cpu?.oldRequest,
  };
    ...
    switch (value) {
      case 'NBALGO':
        setUpdatedData((prevData) => ({
          ...
          cpu: {
            ...prevData.cpu,
            request: (parseFloat(additionalCpuInfo.nbalgo) || '').toFixed(2),
            limit: null,
          },
        }));
        break;
      case 'P99':
        setUpdatedData((prevData) => ({
          ...
          cpu: {
            ...prevData.cpu,
            request: (parseFloat(additionalCpuInfo.p99) || '').toFixed(2),
            limit: null,
          },
        }));
        break;
      case 'P97':
        setUpdatedData((prevData) => ({
          ...
          cpu: {
            ...prevData.cpu,
            request: (parseFloat(additionalCpuInfo.p97) || '').toFixed(2),
            limit: null,
          },
        }));
        break;
      case 'P95':
        setUpdatedData((prevData) => ({
          ...
          cpu: {
            ...prevData.cpu,
            request: (parseFloat(additionalCpuInfo.p95) || '').toFixed(2),
            limit: null,
          },
        }));
        break;
      case 5:
        setUpdatedData((prevData) => ({
          ...
          cpu: {
            ...prevData.cpu,
            request: (parseFloat(additionalCpuInfo[selectedKey]) * 1.05 || '').toFixed(2),
            limit: null,
          },
        }));
        break;
      case 10:
        setUpdatedData((prevData) => ({
          ...
          cpu: {
            ...prevData.cpu,
            request: (parseFloat(additionalCpuInfo[selectedKey]) * 1.1 || '').toFixed(2),
            limit: null,
          },
        }));
        break;
      case 15:
        setUpdatedData((prevData) => ({
          ...
          cpu: {
            ...prevData.cpu,
            request: (parseFloat(additionalCpuInfo[selectedKey]) * 1.15 || '').toFixed(2),
            limit: null,
          },
        }));
        break;
      ...
      >
        ...
        >
          {updateResourceType != 'raise-pr' ? (
            <ToggleButton value='resourceChange' sx={{ gap: '8px', color: colors.text.secondaryDark }}>
              <SafeIcon src={UpdateIcon} alt='Update' />
              Update
            </ToggleButton>
          ) : null}
          <ToggleButton value='raise-pr' sx={{ gap: '8px', color: colors.text.secondaryDark }}>
        ...
        (isGitIntegrationsLoading || filteredGitIntegrations.length > 0 ? (
          <>
            ...
            {selectedWorkloadAnnotations && Object.keys(selectedWorkloadAnnotations).length > 0 ? (
              ...
              >
                <Typography sx={{ fontWeight: '400', fontSize: '14px', color: colors.text.secondary }}>
