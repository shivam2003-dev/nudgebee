...
const ActionBar = ({ fullRecommendation: rec, onCreateTicket, onResolve, onCopyCli, onAskNubi, onDismiss }: ActionBarProps) => {
    ...
    <>
      ...
      >
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
          ...
          <CustomTooltip title='Dismiss'>
            <IconButton
              size='small'
              onClick={() => onDismiss?.(rec)}
              data-testid='action-bar-dismiss'
              sx={{ color: colors.text.tertiary, '&:hover': { color: '#DC2626', backgroundColor: colors.background.accordionSummay } }}
            >
