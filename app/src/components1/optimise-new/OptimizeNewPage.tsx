...
const CATEGORY_FILTER_OPTIONS = [
  ...
  { label: 'Version Upgrade', value: 'K8sVersionUpgrade' },
];
      ...
      <ListingLayout id='optimize-recommendations' sx={{ mt: ds.space[4] }}>
        ...
        >
          <SearchInput
            ...
            onChange={(next) => handleFiltersChange({ ...filters, search: next })}
        ...
        <ListingLayout.Body id='optimize-recommendations-table'>
          <CustomTable2
