...
import { Box, Typography, Chip, Select, MenuItem, FormControl, type SelectChangeEvent } from '@mui/material';
        ...
        >
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 3, flexWrap: 'wrap' }}>
                        ...
                        >
                          <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', width: '100%', gap: 2 }}>
                            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
                              <Chip
                                label={`#${allPlans.length - index}`}
                                size='small'
                                sx={{
                                  height: 22,
                                  fontSize: '11px',
                                  fontWeight: 700,
                                  backgroundColor: isSelected ? '#3B82F6' : colors.background.tertiaryLightest,
                                  color: isSelected ? colors.background.white : colors.text.secondary,
                                  borderRadius: '4px',
                                  minWidth: '32px',
                                }}
                              />
            ...
            {clusterInfo.k8s_provider ? (
              ...
              >
                ...
                <Chip
                  label={clusterInfo.k8s_provider}
                  size='small'
                  sx={{
                    height: 24,
                    fontSize: '13px',
          ...
          {clusterInfo.current_version && clusterInfo.target_version ? (
            ...
            >
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
                ...
                <Chip
                  label={`v${clusterInfo.current_version}`}
                  size='medium'
                  sx={{
                    height: 28,
                    fontSize: '13px',
              ...
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
                ...
                <Chip
                  label={`v${clusterInfo.target_version}`}
                  size='medium'
                  color='primary'
                  sx={{
                    height: 28,
          ...
          <Box sx={{ display: 'flex', gap: 1, alignItems: 'center' }}>
            {upgradeSteps && upgradeSteps.length > 0 && (
              <CustomButton variant='secondary' size='Medium' text='Export Plan' onClick={handleExportPlan} data-testid='export-plan-btn' />
            )}
