...
import { Text, BoxLayout2, ThreeDotsMenu } from '@components1/common';
  ...
  const handleSubmit = useCallback(
    async (fromOnSubmit = false) => {
      ...
      try {
        ...
        if (logProvider === 'pinot' && qLEditor === 'build') {
    ...
    <div>
      ...
      <BoxLayout2
        ...
        sharingOptions={{
          ...
          download: { enabled: true, onClick: () => ({ tableId: k8sLogs }) },
        }}
      >
        {showQueryTextBox && (
