...
import { Typography, Box, Button, TextField, InputAdornment, FormControlLabel, Checkbox } from '@mui/material';
  ...
  return (
    <>
      <Modal width='md' open={isEditing || isCreating} handleClose={() => handleClose()} title={'Node Class Configuration'} loader={formSubmitting}>
        ...
        >
          <CustomButton text={'Cancel'} variant='secondary' size='Medium' onClick={() => handleClose()} disabled={formSubmitting} />
          <CustomButton
            text={`${isEditing ? 'Update' : 'Create'} Node Class`}
            size='Medium'
