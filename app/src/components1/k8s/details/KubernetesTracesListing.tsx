            ...
            component:
              item?.span_name === 'query' && item.resource ? (
                <CustomIconButton
                  ...
                  variant={'secondary'}
                  size={'xsmall'}
                  sx={{ height: '28px', mr: 'var(--ds-space-1)', width: '28px' }}
                >
              ...
              tabs: [
                ...
                },
                {
                  componentFn: function (_opt: any, drilldownQuery: any) {
                    ...
                    return <Typography sx={{ padding: 'var(--ds-space-3)' }}>No Span Attributes Available</Typography>;
                  },
                  ...
                  componentFn: function (_opt: any, drilldownQuery: any) {
                    ...
                    return (
                      <div>
                        ...
                        {drilldownQuery?.headers && drilldownQuery?.request_payload && <div style={{ marginBottom: 'var(--ds-space-2)' }} />}
