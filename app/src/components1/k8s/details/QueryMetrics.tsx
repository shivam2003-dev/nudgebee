...
const QueryMetrics: React.FC<QueryMetricsProps> = ({
  ...
  const TruncationWarning = () => {
    ...
    return (
      ...
      >
        <InfoIcon sx={{ color: 'var(--ds-amber-700)', fontSize: '18px' }} />
  ...
  return (
    <div>
      <ListingLayout id='query-logs' sx={{ mb: '10px' }}>
                ...
                <>
                  {(metricsProvider === 'prometheus' ||
                    ...
                    <>
                      ...
                      <Switch checked={showChartView} onChange={(e) => setShowChartView(e.target.checked)} label='Chart' />
                    </>
                  )}
            ...
            <>
              ...
              {qLEditor === 'code' && (
                <Tooltip
                  ...
                  title='How to use'
                  desc={
                    <Box component='ul' sx={{ m: 0, pl: 2, '& li': { fontSize: '0.75rem', mb: 0.5 } }}>
                ...
                >
                  <InfoIcon sx={{ color: 'var(--ds-gray-500)', opacity: 0.4, fontSize: '18px', cursor: 'default' }} />
                </Tooltip>
              )}
            </>
          )}
        </ListingLayout.Toolbar>
        <ListingLayout.Body sx={{ pb: 2 }}>
          {showQueryBox && (
            <QueryModeSwitcher
              accountId={accountId}
