      ...
      {queryBlocks.map((block, index) => (
        <Box key={block.id} sx={{ display: 'flex', flexDirection: 'row', gap: 2, width: '100%' }}>
          ...
          >
            <Box display={'flex'} flexDirection={'row'} gap={'6px'} width={'90%'} alignItems={'center'}>
              {allowMultipleQueries && (
                <Typography variant='caption' sx={{ fontWeight: 600, color: 'var(--ds-gray-700)' }}>
              ...
              <Box display='flex' flexDirection='row' gap='6px' width='100%'>
                ...
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, width: '90%' }}>
                      ...
                      >
                        <List
                          ...
                          sx={{
                            ...
                            '&::-webkit-scrollbar-thumb': { backgroundColor: 'var(--ds-gray-300)', borderRadius: '2px' },
                          }}
                        >
                            ...
                            <ListItem key={`${suggestion.type}-${suggestion.value}`} disablePadding>
                              ...
                              >
                                <Box component='span' sx={{ display: 'inline-flex', alignItems: 'center', color: 'inherit', flexShrink: 0 }}>
                                  {suggestion.type === 'label' && <LabelIcon sx={{ fontSize: '16px' }} color='success' />}
                                  {suggestion.type === 'operator' && <FilterIcon sx={{ fontSize: '16px' }} color='warning' />}
                                  {suggestion.type === 'value' && <ValueIcon sx={{ fontSize: '16px' }} color='success' />}
                                </Box>
                                <ListItemText
                                  primary={
                  ...
                  {activeBlockId === block.id && (
                    <DsTooltip
                      placement='bottom-start'
                      tooltipStyle={{ maxWidth: '360px', padding: 'var(--ds-space-4)' }}
                      title={
                        <Box>
                          <Typography sx={{ fontSize: 'var(--ds-text-body)', fontWeight: 600, color: 'var(--ds-gray-700)', mb: 0 }}>
                            Filter by {heading}
                          </Typography>
                          <Typography sx={{ fontSize: 'var(--ds-text-small)', color: 'var(--ds-gray-600)', mb: 1.5 }}>
                            {heading === 'Attribute'
                          ...
                          >
                            ...
                            <Typography sx={{ fontSize: 'var(--ds-text-small)', color: 'var(--ds-gray-700)', mb: 0.5 }}>
                          ...
                          >
                            ...
                            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 0.5 }}>
                              ...
                              <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                                <CloseIcon sx={{ fontSize: 'var(--ds-text-caption)', color: 'var(--ds-gray-600)', minWidth: '14px' }} />
                                <Typography sx={{ fontSize: 'var(--ds-text-small)', color: 'var(--ds-gray-700)' }}>
          ...
          {['loki', 'newrelic', 'dynatrace', 'loggly'].includes(logProvider) && providerType !== 'metrics' && activeBlockId === block.id && (
            ...
            >
              <Typography variant='subtitle2' sx={{ mb: 1, fontWeight: 'medium', color: 'var(--ds-gray-700)' }}>
                Operations
              </Typography>
              {block.operations.map((op) => (
                <Box key={op.id} sx={{ display: 'flex', alignItems: 'center', gap: 1, mb: 1 }}>
                  <FilterDropdown
