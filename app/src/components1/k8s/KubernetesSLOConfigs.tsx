    ...
    <>
      <BoxLayout2
        ...
        modalButton={{
          enabled: true,
          text: 'Add SLO',
          onClick: handleOpenSLODialog,
          id: 'add-slo-config-btn',
        }}
        sharingOptions={{
          sharing: {
            enabled: false,
                ...
                ? [
                    {
                      componentFn: function (opt: any, drilldownQuery: any) {
                        return (
                          <SLOEvent drilldownQuery={drilldownQuery} accountId={accountId} sharedVariableForFindingIds={sharedVariableForFindingIds} />
                        );
                      },
                      text: 'Event',
                      value: 3,
