...
const Header1 = ({ showBorder = false }) => {
  ...
  const avatarSubMenu = ['Documentation'];
      ...
      {allCluster && allCluster.length > 0 && !allCluster.some((c) => c.value !== 'demo') && !loading && (
        ...
        >
          ...
          >
            ...
            >
              <InfoOutlinedIcon sx={{ fontSize: '16px', color: '#D97706', flexShrink: 0 }} />
              <span>
              ...
              <Box sx={{ display: 'flex', flexDirection: 'row', gap: '6px' }}>
                ...
                <Box className='headerHelpMenu'>
                  ...
                  >
                    ...
                    {headerMenuExtras().map(({ id, Component }) => (
                      <Component key={id} session={data} onClose={handleCloseUserMenu} />
                    ))}
                  </Menu>
                </Box>
              </Box>
