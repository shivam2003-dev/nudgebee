...
const FilterGroup: React.FC<FilterGroupProps> = ({
  ...
  return (
    ...
    >
        ...
        {filterOptions
          ...
          .map((option) => {
            if (option.type === 'buttons') {
              return (
                <Grid item key={option.id} sx={{ margin: '8px 0px 11px 0px', borderBottom: '1px solid #D0D0D0' }}>
                  <CustomButtonsGroup
                    borderColor='#FFF'
                    fontWeight={500}
                    tabType={true}
              ...
              return (
                <Autocomplete
                  ...
                  value={option.value}
                  options={option.options}
                  popupIcon={<KeyboardArrowDownIcon sx={{ height: '1.1em', width: '1em', color: '#737373' }} />}
      ...
      <Typography sx={{ color: '#737373', mr: '24px' }}>Last 24 hours</Typography>
