          ...
          title={
            <Box minWidth={'190px'} display={'flex'} flexDirection={'column'} gap={'10px'}>
              <Box display={'flex'} justifyContent={'space-between'}>
                <Box sx={{ fontSize: '11px', color: '#737373', display: 'flex', alignItems: 'center', fontWeight: '500' }}>Total</Box>
              ...
              <Box display={'flex'} justifyContent={'space-between'}>
                <Box sx={{ fontSize: '11px', color: '#737373', display: 'flex', alignItems: 'center', fontWeight: '500' }}>
                  {!!iconColor && (
                    <Box
                      sx={{
                        width: '8px',
