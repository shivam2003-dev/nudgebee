      ...
      >
        ...
        >
                        ...
                        >
                          ...
                          {canEdit && (
                            <Button
                              ...
                              tone='secondary'
                              size='sm'
                              icon={<SafeIcon src={SaveIconOutline} alt='Save' width={16} height={16} />}
                          ...
                          {canEdit && !isNewWorkflow && (
                            <Button id='workflow-publish-btn' tone='secondary' size='sm' onClick={openPublishDialog}>
                              Publish
                            </Button>
                          )}
          ...
          <Modal
            ...
            width='sm'
            title={`Restore version ${confirmRestoreVersion?.version_number ?? ''}?`}
            actionButtons={
