              ...
              <Box sx={{ flex: '1 1 300px', minWidth: '200px' }} data-testid={`options-source-${fieldName}`}>
                <FilterDropdownButton
                  ...
                  placeholder={
                    sourceData.loading
                      ? 'Loading...'
                      : /email|recipient/i.test(fieldName)
  ...
  return (
    ...
    >
      ...
      >
        ...
        <IconButton onClick={onClose} sx={{ p: 0.5, '&:hover': { bgcolor: '#f3f4f6' } }}>
      ...
      <Dialog open={disableConfirmOpen} onClose={() => setDisableConfirmOpen(false)} maxWidth='xs' fullWidth>
        <Box sx={{ p: 3 }}>
          ...
          <Box sx={{ display: 'flex', justifyContent: 'flex-end', gap: 1 }}>
            <Button onClick={() => setDisableConfirmOpen(false)} size='small' sx={{ textTransform: 'none' }}>
              Cancel
            </Button>
            <Button
