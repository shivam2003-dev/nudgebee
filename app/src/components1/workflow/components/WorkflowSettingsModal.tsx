...
const WorkflowSettingsModal: React.FC<WorkflowSettingsModalProps> = ({ open, onClose, onSave, initialSettings = defaultSettings, taskTimeouts }) => {
  ...
  const actionButtons = (
    <Box sx={{ display: 'flex', gap: 2, p: 2 }}>
      <CustomButton onClick={handleCancel} text='Cancel' variant='secondary' size='Medium' />
      <CustomButton onClick={handleSave} text='Apply Settings' variant='primary' size='Medium' disabled={taskTimeoutSumExceedsWorkflow} />
    </Box>
  );
