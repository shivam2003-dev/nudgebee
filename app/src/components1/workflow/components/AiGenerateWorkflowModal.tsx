  ...
  const renderActionButtons = () => {
    switch (stage) {
      case 'input':
        return (
          <Box sx={{ p: 2, pt: 0, display: 'flex', gap: 2, justifyContent: 'flex-end', '& button': { minWidth: '140px' } }}>
            <CustomButton text='Cancel' onClick={handleClose} variant='secondary' size='Medium' disabled={loading} />
            <CustomButton
              text={loading ? 'Generating...' : 'Generate Automation'}
      ...
      case 'generating':
        return (
          <Box sx={{ p: 2, pt: 0, display: 'flex', gap: 2, justifyContent: 'flex-end', '& button': { minWidth: '140px' } }}>
            <CustomButton text='Cancel Generation' onClick={handleCancelGeneration} variant='secondary' size='Medium' />
          </Box>
        );
      ...
      case 'plan_review':
        ...
        if (planData?.followupData?.type === 'clarification') {
          return (
            <Box sx={{ p: 2, pt: 0, display: 'flex', gap: 2, justifyContent: 'flex-end', '& button': { minWidth: '140px' } }}>
              <CustomButton text='Cancel' onClick={handleClose} variant='secondary' size='Medium' />
            </Box>
          );
        }
        if (showFeedbackInput) {
          return (
            <Box sx={{ p: 2, pt: 0, display: 'flex', gap: 2, justifyContent: 'flex-end', '& button': { minWidth: '140px' } }}>
              <CustomButton text='Back' onClick={() => setShowFeedbackInput(false)} variant='secondary' size='Medium' />
              <CustomButton text='Submit Changes' onClick={handleSubmitFeedback} variant='primary' size='Medium' disabled={!feedbackText.trim()} />
            </Box>
          );
        }
        ...
        return (
          <Box sx={{ p: 2, pt: 0, display: 'flex', gap: 2, justifyContent: 'flex-end', '& button': { minWidth: '140px' } }}>
            <CustomButton text='Cancel' onClick={handleClose} variant='secondary' size='Medium' />
            <CustomButton text='Request Changes' onClick={handleRequestChanges} variant='secondary' size='Medium' />
            <CustomButton text='Approve and Build' onClick={handleApprove} variant='primary' size='Medium' />
          </Box>
        );
      ...
      case 'text_followup':
        return (
          <Box sx={{ p: 2, pt: 0, display: 'flex', gap: 2, justifyContent: 'flex-end', '& button': { minWidth: '140px' } }}>
            <CustomButton text='Cancel' onClick={handleClose} variant='secondary' size='Medium' />
            <CustomButton text='Submit' onClick={handleSubmitFeedback} variant='primary' size='Medium' disabled={!feedbackText.trim()} />
          </Box>
        );
      ...
      case 'error':
        return (
          <Box sx={{ p: 2, pt: 0, display: 'flex', gap: 2, justifyContent: 'flex-end', '& button': { minWidth: '140px' } }}>
            <CustomButton text='Close' onClick={handleClose} variant='secondary' size='Medium' />
            <CustomButton text='Try Again' onClick={handleRetry} variant='primary' size='Medium' />
          </Box>
        );
