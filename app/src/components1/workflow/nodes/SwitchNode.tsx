      ...
      <Modal open={deleteModalOpen} onClose={handleCancelDelete} sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        ...
        >
          ...
          <Box sx={{ display: 'flex', gap: '12px', justifyContent: 'flex-end' }}>
            <CustomButton id='wf-node-switch-delete-cancel-btn' text='Cancel' variant='tertiary' onClick={handleCancelDelete} />
            <CustomButton id='wf-node-switch-delete-confirm-btn' text='Delete Switch' variant='primary' onClick={handleConfirmDelete} />
          </Box>
        </Box>
      </Modal>
