...
import Tooltip from '@common-new/CustomTooltip';
...
const EDGE_MARKER_END = { type: MarkerType.ArrowClosed, color: '#9ca3af' };
              ...
              <Box key={`detail-${node.value}-${index}`} sx={{ display: 'flex', alignItems: 'center', gap: 'var(--ds-space-1)' }}>
                {index > 0 && node.edgeFromPrev && (
                  ...
                  >
                    ...
                    <Typography sx={{ fontSize: 'var(--ds-text-caption)', color: 'var(--ds-blue-600)', fontWeight: 500 }}>
                      {node.edgeFromPrev}
                    </Typography>
                    <Typography sx={{ fontSize: 'var(--ds-text-caption)', color: 'var(--ds-gray-600)' }}>]→</Typography>
                  </Box>
    ...
    >
      {node.accountName && (
        <Box sx={{ display: 'flex', gap: 'var(--ds-space-2)' }}>
          ...
          <Typography sx={{ fontSize: 'var(--ds-text-caption)', color: '#fff', wordBreak: 'break-word' }}>{node.accountName}</Typography>
        </Box>
      )}
      <Box sx={{ display: 'flex', gap: 'var(--ds-space-2)' }}>
        <Typography sx={{ fontSize: 'var(--ds-text-caption)', color: 'var(--ds-gray-400)', minWidth: '70px' }}>Name:</Typography>
        <Typography sx={{ fontSize: 'var(--ds-text-caption)', color: '#fff', wordBreak: 'break-word' }}>{node.name || '-'}</Typography>
      </Box>
      <Box sx={{ display: 'flex', gap: 'var(--ds-space-2)' }}>
        <Typography sx={{ fontSize: 'var(--ds-text-caption)', color: 'var(--ds-gray-400)', minWidth: '70px' }}>Type:</Typography>
        <Typography sx={{ fontSize: 'var(--ds-text-caption)', color: '#fff' }}>{snakeToTitleCase(node.nodeType || '')}</Typography>
      </Box>
    ...
    <>
      ...
      >
          ...
          >
            ...
            {kgFilterOptions?.lastSyncTime && (
              <Datetime
                ...
                sx={{ fontSize: 'var(--ds-text-caption)', fontWeight: 600, color: 'var(--ds-gray-500)', fontFamily: 'Poppins' }}
                sxSuffix={{ fontSize: 'var(--ds-text-caption)', fontWeight: 600, color: 'var(--ds-gray-500)', fontFamily: 'Poppins' }}
                sxSecondary={false}
        ...
        >
          ...
          <Box sx={{ position: 'absolute', top: '12px', right: '12px', zIndex: 200, display: 'flex', alignItems: 'center', gap: 1 }}>
          ...
          <Box ref={graphWrapperRef} sx={{ flex: 1, position: 'relative' }}>
            ...
            {focusedNodeId && (
              ...
              >
                ...
                <Typography variant='caption' sx={{ color: 'var(--ds-background-100)', fontWeight: 500, fontSize: 'var(--ds-text-small)' }}>
                ...
                >
                  ...
                  <Box sx={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                    ...
                    >
                      ...
                      <Typography component='span' sx={{ fontWeight: 600, color: ds.gray[700], fontSize: 'var(--ds-text-body)' }}>
