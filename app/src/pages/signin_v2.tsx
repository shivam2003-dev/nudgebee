...
export default function SignInV2({ providers, selfSignupEnabled, samlEnabled }: any) {
      ...
      <Box sx={{ textAlign: 'center', mb: '40px' }}>
        ...
        {selfSignupEnabled && (
          ...
          >
            ...
            <Link href='/signup' style={{ color: colors.text.primary, textDecoration: 'none', fontWeight: 500 }}>
              Sign up
            </Link>
          </Typography>
        )}
...
export async function getServerSideProps(_context: any) {
  ...
  // Self-signup is a SaaS-only flow — see signin.tsx for full rationale.
