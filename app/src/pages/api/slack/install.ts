 ...
 * ────────────────────────────────────────────────────────────────────
 *
 * @deprecated  Use /api/integrations/slack/install instead.
 *
...
import handler from '@pages/api/integrations/slack/install';

export default createDeprecatedShim(handler, '/api/integrations/slack/install');
