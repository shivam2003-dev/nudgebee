 ...
 * ────────────────────────────────────────────────────────────────────
 *
 * @deprecated  Use /api/integrations/slack/callback instead.
 *
 * Slack OAuth callback shim kept so external systems (OAuth providers, cloud
...
import handler from '@pages/api/integrations/slack/callback';

export default createDeprecatedShim(handler, '/api/integrations/slack/callback');
