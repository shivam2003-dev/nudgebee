...
// bodyParser sizeLimit kept in sync with /api/graphql so non-browser callers
// (nbctl, external API) can invoke the same actions — notably
// `ai_execute_investigation` with base64-inlined image attachments. If you
// raise/lower one, raise/lower the other.
export const config = {
  api: {
    responseLimit: false,
    bodyParser: {
