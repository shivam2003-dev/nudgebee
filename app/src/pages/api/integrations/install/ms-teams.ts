 ...
 * ────────────────────────────────────────────────────────────────────
 *
 * @deprecated  Use /api/integrations/ms-teams/install instead.
 *
 * OAuth install shim kept so external systems (OAuth providers, cloud
...
import handler from '@pages/api/integrations/ms-teams/install';

export default createDeprecatedShim(handler, '/api/integrations/ms-teams/install');
