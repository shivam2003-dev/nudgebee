 ...
 * ────────────────────────────────────────────────────────────────────
 *
 * @deprecated  Use /api/integrations/google/install instead.
 *
...
import handler from '@pages/api/integrations/google/install';

export default createDeprecatedShim(handler, '/api/integrations/google/install');
