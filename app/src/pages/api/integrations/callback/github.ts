 ...
 * ────────────────────────────────────────────────────────────────────
 *
 * @deprecated  Use /api/integrations/github/callback instead.
 *
 * GitHub OAuth callback shim kept so external systems (OAuth providers, cloud
...
import handler from '@pages/api/integrations/github/callback';

export default createDeprecatedShim(handler, '/api/integrations/github/callback');
