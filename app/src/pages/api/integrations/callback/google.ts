 ...
 * ────────────────────────────────────────────────────────────────────
 *
 * @deprecated  Use /api/integrations/google/callback instead.
 *
 * Google OAuth callback shim kept so external systems (OAuth providers, cloud
...
import handler from '@pages/api/integrations/google/callback';

export default createDeprecatedShim(handler, '/api/integrations/google/callback');
