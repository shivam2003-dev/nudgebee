...
import TextWithBorder from '@common-new/TextWithBorder';
import CustomDivider from '@common-new/CustomDivider';
...
import CustomCheckBox from '@common-new/CustomCheckbox';
    ...
    <>
      ...
      >
        <Box sx={{ padding: '12px 24px 12px 24px' }}>
          ...
          <CustomDivider borderColor={'var(--ds-background-200)'} margin={'24px 0px'} />
          ...
          >
            {featureOptions?.map((f) => (
              <CustomCheckBox
                ...
                checkboxStyle={{ fontSize: 'var(--ds-text-small)' }}
              />
            ))}
          </Box>
        </Box>
