/**
 * @deprecated Use <Button composition="icon-only" /> from '@components1/ds/Button' instead.
...
const CustomIconButton = ({
  ...
  if (tooltip) {
    return (
      <CustomTooltip title={tooltip} placement={tooltipPlacement} tooltipStyle={tooltipStyle} tooltipClassName={tooltipClassName}>
        {iconButton}
      </CustomTooltip>
    );
  }
