...
export function Input({
  ...
  const inputEl = isTextarea ? (
    // @ts-expect-error MUI Box prop forwarding doesn't type minRows/maxRows on textarea
    <Box component='textarea' rows={rows} minRows={minRows} maxRows={maxRows} {...sharedInputProps} />
  ) : (
