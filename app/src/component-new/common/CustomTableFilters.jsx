  ...
  return (
    <Box className={`custom-dropdown ${showBorder ? 'custom-dropdown-props' : ''}`}>
      <Box display={'flex'} alignItems={'center'} justifyContent={'space-between'} py={'10px'}>
        ...
        <Typography color={colors.text.primary} fontWeight={500} fontSize={'var(--ds-text-small)'} sx={{ cursor: 'pointer' }} onClick={onClearAll}>
          Clear All
        </Typography>
      </Box>
      <CustomDivider />
          ...
          return (
            <>
              ...
              >
                ...
                >
                  <Typography color={colors.text.secondary} fontWeight={500} fontSize={'var(--ds-text-small)'}>
                    {option.label}
                  </Typography>
                    ...
                    if (option.type === 'buttons') {
                              ...
                              <List className='option-dropdown-list'>
                                <ListItem disablePadding>
                                  <ListItemButton dense onClick={handleSelectAll}>
                                    ...
                                    <ListItemText primary={'Select All'} sx={{ fontSize: 'var(--ds-text-small) !important' }} />
                                  </ListItemButton>
                                </ListItem>
                              </List>
                              ...
                              <List className='option-dropdown-list'>
                                <ListItem disablePadding>
                                  <ListItemButton dense onClick={handleClear}>
                                    ...
                                    <ListItemText primary={'Clear All'} sx={{ fontSize: 'var(--ds-text-small) !important' }} />
                                  </ListItemButton>
                                </ListItem>
                              </List>
                              <Divider sx={{ color: colors.border.vertical }} />
                      ...
                      return (
                        <>
                          ...
                          <Switch id={`${option?.id}`} onChange={(event) => option.onSelect(event.target.checked)} checked={option.value} />
                        </>
                      );
                    }
                  })()}
