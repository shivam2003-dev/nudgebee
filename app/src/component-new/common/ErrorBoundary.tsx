  ...
  return (
    <div style={{ width: '100%', minHeight: '280px', flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      ...
      >
        ...
        <p style={{ fontSize: 'var(--ds-text-body-lg)', fontWeight: 600, color: 'var(--ds-gray-700)', margin: 0 }}>Something went wrong</p>
...
function FullPageFallback({ onGoHome }: Readonly<{ onGoHome: () => void }>) {
  return (
    ...
    >
      ...
      >
        <h1 style={{ fontSize: '170px', fontWeight: 'bold', margin: '0px', color: 'var(--ds-gray-700)' }}>500</h1>
        <p style={{ fontSize: '15px', fontWeight: 500, margin: '0px', color: 'var(--ds-gray-700)' }}>
