/**
 * @deprecated Use `Stepper` from '@components1/ds/Stepper' instead.
 * V2 absorbs this + CustomStepper + NewVerticalStepper into one primitive with
 * orientation, state, and interactivity variants. Uses --ds-* tokens.
 * Tracked for removal 2026-06-06 (30-day deprecation clock from V2 ship 2026-05-07).
 */
import React, { useState, useEffect } from 'react';
import { Box, Button, Typography, Collapse } from '@mui/material';

let _verticalStepNavigationWarned = false;
...
function _warnVerticalStepNavigation() {
  if (_verticalStepNavigationWarned) return;
  _verticalStepNavigationWarned = true;
  // eslint-disable-next-line no-console
  console.warn(
    '[deprecated] VerticalStepNavigation is deprecated. Use `import { Stepper } from "@components1/ds/Stepper"` instead. ' +
