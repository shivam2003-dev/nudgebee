...
const CustomLabels: React.FC<CustomLabelsProps> = ({
  ...
  const labelNode = (
    <Label
      ...
      // Style overrides preserved at the wrapper level — ds/Label is intentionally
      // tokenized, but the V1 callers expect tunable margin/width/maxWidth/textTransform.
    >
      <Box
        component='span'
        sx={{
