// https://www.webtoolkit.info/javascript-md5.html
function _md5(data: string): string {
  ...
  function ConvertToWordArray(data: string) {
    let lWordCount;
  ...
  function Utf8Encode(data: string) {
    data = data.replace(/\r\n/g, '\n');
